...
class Controller:
    ...
    def changesystembrightness(self):
        currentBrightnessLv = int(sbcontrol.get_brightness())/ 100.0
    ...
    def pinch_control(hand_result, controlHorizontal, controlVertical, self=None):
        if Controller.framecount == 5:
            Controller.framecount = 0
            Controller.pinchlv = Controller.prevpinchlv

            if Controller.pinchdirectionflag == True:
                controlHorizontal(self)  # x

            elif Controller.pinchdirectionflag == False:
                controlVertical(self)  # y
